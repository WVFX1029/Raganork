...
await message.client.sendMessage(message.jid, fs.readFileSync('./sana-media/bgm/music.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted : message.data, ptt: true})
        }
